...
#endif
{
    ...
    Y_bot->Add_Device_Type(Switch_Board_Orin_Type, Switch_Board_Orin_Device_Init,
    ...
    string ADDR = dir_path.string() + "/../config/YAML/Y_Bot/out/mz_g_orin_fdcan_1.0/TOP.yaml";
#endif
    if (Y_bot->Init_TOP(ADDR) != 0) {
        cout << "Init_ERR" << endl;
        return -1;
    }
